...
export interface IStorage {
  ...
  createInvestment(data: { userId: string; fundPlanId: string; planName: string; investedAmount: string; dailyProfit: string; endDate: Date | null; lastProfitDate?: string }): Promise<Investment>;
...
export class DatabaseStorage implements IStorage {
  ...
  async createInvestment(data: { userId: string; fundPlanId: string; planName: string; investedAmount: string; dailyProfit: string; endDate: Date | null; lastProfitDate?: string }): Promise<Investment> {

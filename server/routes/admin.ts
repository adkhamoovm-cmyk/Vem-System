...
import { requireAuth, requireAdmin, sendNotification, sendRawNotification, hashPassword, pinRateLimiter, webpush } from "../lib/helpers";
...
router.post("/api/admin/users/:id/ban", requireAdmin, async (req: Request, res: Response) => {
  try {
...
router.post("/api/admin/users/:id/withdrawal-ban", requireAdmin, async (req: Request, res: Response) => {
  try {
...
router.post("/api/admin/users/:id/balance", requireAdmin, async (req: Request, res: Response) => {
  try {
...
router.post("/api/admin/users/:id/vip", requireAdmin, async (req: Request, res: Response) => {
  try {
...
router.post("/api/admin/users/:id/password", requireAdmin, async (req: Request, res: Response) => {
  try {
...
router.post("/api/admin/vip-packages/:id/toggle-lock", requireAdmin, async (req: Request, res: Response) => {
  try {
...
router.delete("/api/admin/payment-methods/:id", requireAdmin, async (req: Request, res: Response) => {
  try {
...
router.get("/api/admin/deposits", requireAdmin, async (_req: Request, res: Response) => {
  try {
...
router.post("/api/admin/deposits/:id/approve", requireAdmin, async (req: Request, res: Response) => {
  try {
...
router.post("/api/admin/deposits/:id/reject", requireAdmin, async (req: Request, res: Response) => {
  try {
    const deposit = await storage.getDepositById(req.params.id as string);
    if (!deposit) return res.status(404).json({ message: "Depozit topilmadi" });
...
router.get("/api/admin/withdrawals", requireAdmin, async (_req: Request, res: Response) => {
  try {
...
router.post("/api/admin/withdrawals/:id/approve", requireAdmin, async (req: Request, res: Response) => {
  try {
...
router.post("/api/admin/withdrawals/:id/reject", requireAdmin, async (req: Request, res: Response) => {
  try {
    const withdrawal = await storage.getWithdrawalById(req.params.id as string);
    if (!withdrawal) return res.status(404).json({ message: "So'rov topilmadi" });
...
router.get("/api/admin/deposit-settings", requireAdmin, async (_req: Request, res: Response) => {
  try {
...
router.post("/api/admin/deposit-settings", requireAdmin, async (req: Request, res: Response) => {
  try {
...
router.delete("/api/admin/deposit-settings/:id", requireAdmin, async (req: Request, res: Response) => {
  try {
...
router.get("/api/admin/top-referrers", requireAdmin, async (_req: Request, res: Response) => {
  try {
...
router.get("/api/admin/multi-accounts", requireAdmin, async (_req: Request, res: Response) => {
  try {
...
router.get("/api/admin/referral-tree/:userId", requireAdmin, async (req: Request, res: Response) => {
  try {
...
router.post("/api/stajyor/request", requireAuth, async (req: Request, res: Response) => {
  try {
...
router.get("/api/stajyor/status", requireAuth, async (req: Request, res: Response) => {
  try {
...
router.get("/api/admin/stajyor-requests", requireAdmin, async (_req: Request, res: Response) => {
  try {
...
router.post("/api/admin/stajyor-requests/:id/approve", requireAdmin, async (req: Request, res: Response) => {
  try {
    const requests = await storage.getAllStajyorRequests();
...
router.post("/api/admin/stajyor-requests/:id/reject", requireAdmin, async (req: Request, res: Response) => {
  try {
    const requests = await storage.getAllStajyorRequests();
    const request = requests.find(r => r.id === req.params.id);
    if (!request) return res.status(404).json({ message: "So'rov topilmadi" });
...
router.get("/api/deposit-settings/active", requireAuth, async (_req: Request, res: Response) => {
  try {
    const settings = await storage.getDepositSettings();
...
router.get("/api/platform-settings", requireAuth, async (_req: Request, res: Response) => {
  try {
...
router.get("/api/admin/platform-settings", requireAdmin, async (_req: Request, res: Response) => {
  try {
    const rows = await storage.getPlatformSettings();
    const map: Record<string, string> = {};
    for (const r of rows) map[r.key] = r.value;
...
router.post("/api/admin/platform-settings", requireAdmin, async (req: Request, res: Response) => {
  try {
...
router.get("/api/broadcasts/unread", requireAuth, async (req: Request, res: Response) => {
  try {
    const userId = req.session.userId!;
...
router.post("/api/broadcasts/:id/read", requireAuth, async (req: Request, res: Response) => {
  try {
    const userId = req.session.userId!;
...
router.get("/api/admin/broadcasts", requireAdmin, async (_req: Request, res: Response) => {
  try {
...
router.post("/api/admin/broadcasts", requireAdmin, async (req: Request, res: Response) => {
  try {
...
router.delete("/api/admin/broadcasts/:id", requireAdmin, async (req: Request, res: Response) => {
  try {
...
router.post("/api/admin/push-send", requireAdmin, async (req: Request, res: Response) => {
  try {
...
router.get("/api/admin/push-stats", requireAdmin, async (_req: Request, res: Response) => {
  try {
...
router.post("/api/promo/use", requireAuth, async (req: Request, res: Response) => {
  try {
    const { code } = req.body;
...
router.get("/api/promo/history", requireAuth, async (req: Request, res: Response) => {
  try {
...
router.post("/api/admin/promo-codes", requireAdmin, async (req: Request, res: Response) => {
  try {
...
router.get("/api/admin/promo-codes", requireAdmin, async (req: Request, res: Response) => {
  try {
...
router.get("/api/admin/promo-codes/:id/usages", requireAdmin, async (req: Request, res: Response) => {
  try {
...
router.post("/api/admin/promo-codes/:id/deactivate", requireAdmin, async (req: Request, res: Response) => {
  try {
...
router.delete("/api/admin/promo-codes/:id", requireAdmin, async (req: Request, res: Response) => {
  try {

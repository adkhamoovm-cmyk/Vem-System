...
export const users = pgTable("users", {
  ...
  fundEnabled: boolean("fund_enabled").notNull().default(false),
...
export const promoCodeUsages = pgTable("promo_code_usages", {
  ...
  uniqueIndex("uq_promo_user").on(table.promoCodeId, table.userId),
]);
...
export type UserSessionLog = typeof userSessions.$inferSelect;

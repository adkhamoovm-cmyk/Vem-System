...
export default function FundPage() {
  ...
  return (
    <div className="px-4 py-4 space-y-4 pb-24">
      <div className="relative rounded-2xl overflow-hidden bg-gradient-to-br from-primary via-blue-600 to-indigo-700 p-5 shadow-xl shadow-primary/20" data-testid="fund-header">

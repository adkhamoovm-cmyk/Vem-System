...
const serverMessageMap: Record<string, string> = {
  ...
  "Juda ko'p so'rov. Biroz kuting.": "server.rateLimitGeneral",
  "Admin PIN sozlanmagan": "server.adminPinNotSet",
  "Bu videoni bugun allaqachon ko'rgansiz": "server.videoAlreadyWatched",
  "Daraja ochildi": "server.levelOpened",
  "Daraja yopildi": "server.levelClosed",
  "Foydalanuvchi bloklandi": "server.userBlocked",
  "Foydalanuvchi blokdan chiqarildi": "server.userUnblocked",
  "Joriy PIN kod noto'g'ri": "server.currentPinWrong",
  "Joriy sessiyani o'chirish mumkin emas": "server.cannotTerminateCurrent",
  "Moliya kodi sozlanmagan. Profildan avval sozlang.": "server.fundCodeNotSet",
  "Moliya paroli o'rnatilmagan. Profildan moliya parolini o'rnating.": "server.fundPasswordNotConfigured",
  "Noto'g'ri balans qiymati": "server.invalidBalanceValue",
  "Noto'g'ri ma'lumotlar": "server.invalidCredentials",
  "Noto'g'ri VIP daraja yoki limit qiymati": "server.invalidVipOrLimit",
  "PIN kod muvaffaqiyatli o'zgartirildi": "server.pinChanged",
  "PIN kod noto'g'ri": "server.pinWrong",
  "PIN tasdiqlandi": "server.pinConfirmed",
  "Pul yechish vaqtincha to'xtatilgan. Iltimos, keyinroq urinib ko'ring.": "server.withdrawalTemporarilyStopped",
  "Sessiya topilmadi": "server.sessionNotFound",
  "Sessiya tugatildi": "server.sessionTerminated",
  "Sizda allaqachon faol investitsiya mavjud. Muddat tugagandan so'ng yangi investitsiya qo'sha olasiz.": "server.activeInvestmentExists",
  "Sizning hisobingiz bloklangan.": "server.accountBlockedShort",
  "So'rovingiz rad etildi. Iltimos qayta urinib ko'ring.": "server.requestRejectedRetry",
  "Sozlamalar saqlandi": "server.settingsSaved",
  "Stajyor faollashtirildi!": "server.stajyorActivatedShort",
  "Stajyor so'rovi rad etildi": "server.stajyorRequestRejected",
  "Xabar majburiy": "server.messageRequired",
  "Yechish rad etildi va balans qaytarildi": "server.withdrawalRejectedRefunded",
  "Pul yechish tasdiqlandi": "server.withdrawalConfirmed",
  "Pul yechish rad etildi": "server.withdrawalDenied",
  "Pul yechish ruxsat berildi": "server.withdrawalAllowed",
  "Pul yechish taqiqlandi": "server.withdrawalForbidden",
  "Promokod qabul qilindi": "server.promoAccepted",
  "Depozit tasdiqlandi": "server.depositConfirmed",
};
